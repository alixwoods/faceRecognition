            ...
            <Card.Body className="card-body-nopadding">
              ...
              >
                <WizardNav className="wizard-steps">
                  <WizardNavItem className="text-center">
                    <span className="badge">1</span> Account
                  </WizardNavItem>
                  <WizardNavItem className="text-center">
                    <span className="badge">2</span> Profile
                  </WizardNavItem>
                  <WizardNavItem className="text-center">
                    <span className="badge">3</span> Confirm
                  </WizardNavItem>
                </WizardNav>
          ...
          <Card className="mb-4">
            <Card.Body className="p-0 tabs bg-transparent mb-0">
              <Wizard
                ...
                onFinish={wizardCompleted}
              >
                <WizardNav className="nav-tabs nav-justify">
                  <WizardNavItem className="border-bottom-0 text-center">
                    <span className="badge badge-primary">1</span> Account
                  </WizardNavItem>
                  <WizardNavItem className="border-bottom-0 text-center">
                    <span className="badge badge-primary">2</span> Profile
                  </WizardNavItem>
                  <WizardNavItem className="border-bottom-0 text-center">
                    <span className="badge badge-primary">3</span> Confirm
                  </WizardNavItem>
                </WizardNav>
