...
function Sidebar(props) {
  ...
  function getOpenState(item) {
    return !item.children.find(
      (child) =>
        child.url === props.location.pathname ||
        (child.children &&
          child.children.find((sub) => sub.url === props.location.pathname))
    );
  }
  ...
  return (
    <aside
      ...
      style={{ right: 0, position: "fixed", left: "initial", direction: "rtl" }}
    >
      ...
      <div className="nano">
        <div className="nano-content">
          <nav id="menu">
            <ul className="nav nav-main" style={{ marginRight: "-40px" }}>
