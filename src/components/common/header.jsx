...
export default function Header(props) {
  ...
  return (
    <header className="header header-nav-menu header-nav-links">
      <div className="logo-container" style={{ textAlign: "right" }}>
        <Link
          to={"./"}
          className="logo"
          style={{ right: "110px", left: "initial" }}
        >
          <img
            src={`/assets/images/Logo-barik.png`}
      ...
      >
        ...
        {/* <Form
          action="#"
          className={`search search-style-1 nav-form d-none d-xl-inline-block ${
            search ? "active" : ""
          }`}
          onSubmit={prevent}
        >
                  ...
                  <ul>
                    <li>
                      <p className="clearfix mb-1">
                        <span className="message float-left">
                          Generating Sales Report
                        </span>
                        <span className="message float-right text-dark">
                          60%
                        </span>
                      </p>
        ...
        {/* <Link to={`/EditProfile`}> */}
          {/* <div id="userbox" className={`userbox ${showUserBox ? "show" : ""}`}>
            ...
            <div
              ...
              style={{ direction: "rtl", marginTop: "3px" }}
            >
              <span className="name">
...
<div id="userbox" className={ `userbox ${ showUserBox ? 'show' : '' }` }>
                    <a href="#no" onClick={ onToggleUserBox }>
                        <span className="profile-picture "> <img
              src={props.ProfileImg}
              style={{ borderRadius: "50%", height: "50px", width: "50px" }}
            /></span>
                        <div className="profile-info profile-info-no-role">
                            <span className="name"> <strong className="font-weight-semibold">{props.accountName}</strong></span>
                        </div>
                        <i className="fas fa-chevron-down text-color-dark"></i>
                    </a>
                    ...
                    <div className={ `dropdown-menu ${ showUserBox ? 'show' : '' }` }>
                        <ul className="list-unstyled" style={{textAlign:"right"}}>
                            <li onClick={ onToggleUserBox }>
                                <Link to={ `/EditProfile` } >
                                پروفایل <i className="bx bx-user"></i> </Link>
                            </li>
                            <li onClick={ onToggleUserBox }>
                                <Link to={ `/ChangePassword` }  > تغییر رمز عبور<i className="bx bxs-key"></i></Link>
                            </li>
                            <li onClick={ onToggleUserBox }>
                                <Link to={ `/signup` }  >خروج<i className="bx bx-log-out"></i></Link>
                            </li>
                        </ul>
                    </div>
                </div>
